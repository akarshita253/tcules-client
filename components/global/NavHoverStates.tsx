          ...
          return (
            <div key={singleNavLink?.id} className="">
              ...
              {active === index && levelTwo.length > 0 && (
                <div className="absolute top-[calc(100%-0.7rem)] left-0 right-0 shadow-lg max-w-6xl w-auto mx-auto bg-neutral-50 z-100">
                  <div
                    className={
                      index === 3
                  ...
                  >
                    ...
                    >
                      ...
                      {singleNavLink?.navLevelTwoGroup?.at(-1)?.description && (
                        <p>
                          {singleNavLink?.navLevelTwoGroup?.at(-1)?.description}
                        </p>
                      )}
